...
simple = {
           ...
           #"arg"    : "  mov rax, <1>\n  shl rax, 3\n  add rax, Arguments\n  mov <2>, qword [rax]\n",
           #"ret"    : "  mov rax, <2>\n  shl rax, 3\n  add rax, Arguments\n  mov qword [rax], <1>\n",
           "arg"    : "  mov <2>, qword [Arguments + (8*<1>)]\n",
           "ret"    : "  mov qword [Arguments + (8*<2>)], <1>\n",
    ...
    for op in code:
        ...
        if op == "include":
            ...
            for lib in operands:
                ...
                includes.add( os.path.expanduser( os.path.join(lib_directory, lib, "main.o") ) )
                externs += "include '%s'\n" % ( os.path.expanduser( os.path.join(lib_directory, lib, "declares.asm") ) )
